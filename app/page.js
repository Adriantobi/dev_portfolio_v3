        ...
        <div className={styles.infoWrapper}>
          ...
          <div className={styles.skills}>
            ...
            <span className={styles.langList}>
              {langs.map((lang) =>
                <span key={lang} className={styles.langItem}>{lang}</span>
              )}
            </span>
          </div>
