...
export default function BentoGrid() {
    ...
    return (
        <div className={styles.BentoGrid}>
            ...
            <ProjectBento link={'https://adriantdv2.netlify.app/'} title={'adriantd.com (v2)'} description={"No frameworks, no plugins, just HTML. This hand-coded portfolio from 2019 is a testament to my dedication and understanding of the web's building blocks."} image={'/adriansPortfoliov2.jpg'} />
